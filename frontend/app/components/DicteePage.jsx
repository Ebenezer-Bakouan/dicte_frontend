...
import { Play, Pause, RotateCcw, Volume2, VolumeX, CheckCircle, AlertCircle, ArrowLeft } from 'lucide-react';

export default function DicteePage({ config, onBack }) {
  ...
  useEffect(() => {
    if (audioRef.current) {
      audioRef.current.addEventListener('loadedmetadata', () => {
        setDuration(audioRef.current.duration || 60); // Durée simulée
      });
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="text-center">
            ...
            <p className="text-sm text-gray-600 mt-1">
              Thème: {config?.parametresDictee?.sujet || 'Non spécifié'}
            </p>
          </div>
